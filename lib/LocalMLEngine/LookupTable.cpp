...
const PlantCharacteristics LookupTable::PLANT_DATABASE[5] PROGMEM = {
    // Essential plants only for memory optimization
    ...
    {"Generic", 450, 22, 60, 650, 140, 0.8, 1.0, 1.2, 1.1, 1.0},  // Generic fallback
